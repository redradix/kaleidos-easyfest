     ...
     <div class="container">
        ...
        <div id="mainMenu" class="navbar-menu">
            ...
            <div class="navbar-end">
                ...
                <a href="/registration" class="button is-primary register-cta">{data.register_cta}</a>
                {/if}
            </div>
        </div>
        {/if}
...
{#if isRegistrationOpen}
<div><a href="/registration" class="button is-primary register-cta is-sticky">{data.register_cta}</a></div>
{/if}
